...
const (
	BlogService_CreageBlog_FullMethodName = "/blog.BlogService/CreageBlog"
...
type BlogServiceClient interface {
	CreageBlog(ctx context.Context, in *Blog, opts ...grpc.CallOption) (*BlogId, error)
...
func (c *blogServiceClient) CreageBlog(ctx context.Context, in *Blog, opts ...grpc.CallOption) (*BlogId, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BlogId)
	err := c.cc.Invoke(ctx, BlogService_CreageBlog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlogServiceServer interface {
	CreageBlog(context.Context, *Blog) (*BlogId, error)
...
func (UnimplementedBlogServiceServer) CreageBlog(context.Context, *Blog) (*BlogId, error) {
	return nil, status.Error(codes.Unimplemented, "method CreageBlog not implemented")
}
...
func _BlogService_CreageBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Blog)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlogServiceServer).CreageBlog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BlogService_CreageBlog_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).CreageBlog(ctx, req.(*Blog))
	}
...
var BlogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreageBlog",
			Handler:    _BlogService_CreageBlog_Handler,
		},
		{
			MethodName: "ReadBlog",
